...
public class WaveLoadingView extends View {
    ...
    private static final int DEFAULT_WAVE_COLOR = Color.parseColor("#FF4282");
    private static final int DEFAULT_WAVE_BACKGROUND_COLOR = Color.parseColor("#00000000");
    private static final int DEFAULT_TITLE_COLOR = Color.parseColor("#FCE4EC");
    ...
    private static final float DEFAULT_TITLE_TOP_SIZE = 10.0f;
    private static final float DEFAULT_TITLE_CENTER_SIZE = 20.0f;

    private static final float DEFAULT_TITLE_BOTTOM_SIZE = 10.0f;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "rirl.ttf");
        mTopTitlePaint.setTypeface(tf);
        ...
        mCenterTitlePaint.setTypeface(tf);
        ...
        mBottomTitlePaint.setTypeface(tf);
...
//                                (getWidth() - borderWidth) / 2f - 1f, mBorderPaint);
                        ...
                        canvas.drawColor(getContext().getResources().getColor(R.color.colorTranst));
                        Path path = new Path();
...
//                        mBorderPaint.setStyle(Paint.Style.STROKE);
            ...
            if (!TextUtils.isEmpty(mTopTitle)) {
                ...
                canvas.drawText(mTopTitle, (getWidth() - top) / 2,
                        getHeight() * 2.5f  / 10.0f, mTopTitleStrokePaint);
                // Draw the top text
                canvas.drawText(mTopTitle, (getWidth() - top) / 2,
                        getHeight() * 2.5f / 10.0f, mTopTitlePaint);
            }
            ...
            if (!TextUtils.isEmpty(mBottomTitle)) {
                ...
                canvas.drawText(mBottomTitle, (getWidth() - bottom) / 2,
                        getHeight() * 7.5f / 10.0f - ((mBottomTitleStrokePaint.descent() + mBottomTitleStrokePaint.ascent()) / 2), mBottomTitleStrokePaint);
                // Draw the bottom text
                canvas.drawText(mBottomTitle, (getWidth() - bottom) / 2,
                        getHeight() * 7.5f / 10.0f - ((mBottomTitlePaint.descent() + mBottomTitlePaint.ascent()) / 2), mBottomTitlePaint);
            }
        } else {
...
//        mWaveShader = null;
    ...
    private void initAnimation() {
        ...
        waveShiftAnim.setDuration(7500);
